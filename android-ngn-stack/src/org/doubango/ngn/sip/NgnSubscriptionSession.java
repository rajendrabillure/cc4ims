...
public class NgnSubscriptionSession extends NgnSipSession{
	...
	public static NgnSubscriptionSession createOutgoingSession(NgnSipStack sipStack, String toUri, EventPackageType eventPackage, String fromUri) {
		synchronized (sSessions) {
			final NgnSubscriptionSession subSession = new NgnSubscriptionSession(sipStack, toUri, eventPackage, fromUri);
			sSessions.put(subSession.getId(), subSession);
			return subSession;
		}
	}
	...
	public NgnSubscriptionSession(NgnSipStack sipStack, String toUri, EventPackageType eventPackage){
		super(sipStack);
	...
	public NgnSubscriptionSession(NgnSipStack sipStack, String toUri, EventPackageType eventPackage, String fromUri){
		super(sipStack);
		mSession = new SubscriptionSession(sipStack);
		super.init();
